...
// -------------------------- 硬件配置（根据你的MCU修改） --------------------------
// 433发射模块控制IO（推挽输出）
#define TX_PIN_PORT    GpioPortB
#define TX_PIN_PIN     GpioPin12
...
#define DELAY_US(x)    delay10us(x/10)

// -------------------------- 协议时序宏定义（严格按协议） --------------------------
#define T0H_US         400U    // 逻辑0 高电平时间 0.4ms = 400us
#define T0L_US         1200U   // 逻辑0 低电平时间 1.2ms = 1200us
#define T1H_US         1200U   // 逻辑1 高电平时间 1.2ms = 1200us
#define T1L_US         400U    // 逻辑1 低电平时间 0.4ms = 400us
#define STOP_H_US      400U    // 结束位 高电平时间 0.4ms = 400us
#define STOP_L_US      400U    // 结束位 低电平时间 0.4ms = 400us
#define FRAME_INTERVAL 12000U  // 帧间隔时间 12ms = 12000us
